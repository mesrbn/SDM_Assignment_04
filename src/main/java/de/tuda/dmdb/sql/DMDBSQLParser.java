...
import de.tuda.dmdb.sql.statement.CommitStatement;
import de.tuda.dmdb.sql.statement.Constant;
import de.tuda.dmdb.sql.statement.CreateIndexStatement;
import de.tuda.dmdb.sql.statement.CreateTableStatement;
import de.tuda.dmdb.sql.statement.InsertStatement;
import de.tuda.dmdb.sql.statement.Predicate;
import de.tuda.dmdb.sql.statement.SelectStatement;
import de.tuda.dmdb.sql.statement.SimplePredicate;
import de.tuda.dmdb.sql.statement.Statement;
import de.tuda.dmdb.storage.types.EnumSQLType;

public class DMDBSQLParser extends Parser {
    ...
    // delegators
        ...
        public DMDBSQLParser(TokenStream input) {
            this(input, new RecognizerSharedState());
        }
        public DMDBSQLParser(TokenStream input, RecognizerSharedState state) {
            super(input, state);
             
        }
        

    public String[] getTokenNames() { return DMDBSQLParser.tokenNames; }
            ...
            switch (alt14) {
                case 1 :
                    ...
                    INTEGER17=(Token)match(input,INTEGER,FOLLOW_INTEGER_in_constant3601); 
                                    	...
                                    	value.setType(EnumSQLType.SqlInteger);
                ...
                case 2 :
                    ...
                    STRING18=(Token)match(input,STRING,FOLLOW_STRING_in_constant3639); 
                                    	...
                                    	value.setType(EnumSQLType.SqlVarchar);
            ...
            switch (alt15) {
                case 1 :
                    ...
                    match(input,TYPE_INT,FOLLOW_TYPE_INT_in_sqlType3697); 
                     			...
                     			type.setType(EnumSQLType.SqlInteger);
                ...
                case 2 :
                    ...
                    match(input,RPAREN,FOLLOW_RPAREN_in_sqlType3716); 
                     			...
                     			type.setType(EnumSQLType.SqlVarchar);
